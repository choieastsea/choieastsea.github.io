...
excerpt: "헷갈리는 나를 위한 마크다운 정리, 태그를 이용한 이미지 관리"
...
```html
<img src="https://upload.wikimedia.org/wikipedia/ko/thumb/4/43/Wikipedia-ko.svg/720px-Wikipedia-ko.svg.png" alt="위키백과 로고 사진" style="zoom:50%; display: block; margin: 0 auto" />
```
